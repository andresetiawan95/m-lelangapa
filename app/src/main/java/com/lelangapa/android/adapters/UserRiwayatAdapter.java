...
public class UserRiwayatAdapter extends RecyclerView.Adapter<UserRiwayatAdapter.RiwayatViewHolder>{
    private Context context;
    private ArrayList<RiwayatResources> listRiwayat;
    public UserRiwayatAdapter(Context context, ArrayList<RiwayatResources> listRiwayat)
    {
    ...
    public class RiwayatViewHolder extends RecyclerView.ViewHolder {
        ...
        {
            super(view);
            cardView = (CardView) view.findViewById(R.id.fragment_user_riwayat_noempty_cardview);
            textView_judulItem = (TextView) view.findViewById(R.id.fragment_user_riwayat_noempty_judulitem);
            textView_namaAuctioneer = (TextView) view.findViewById(R.id.fragment_user_riwayat_noempty_namaauctioneer);
            textView_kalibid = (TextView) view.findViewById(R.id.fragment_user_riwayat_noempty_bidkali);
            textView_hargabid = (TextView) view.findViewById(R.id.fragment_user_riwayat_noempty_hargabid);
            textView_statuswin = (TextView) view.findViewById(R.id.fragment_user_riwayat_noempty_statuswin);
            imageView_imageItem = (ImageView) view.findViewById(R.id.fragment_user_riwayat_noempty_image);
        }
    }
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_user_riwayat_noempty_layout_carditems, parent, false);
        return new UserRiwayatAdapter.RiwayatViewHolder(itemView);
    }
