...
public class UnfavoriteTrashToggler {
    ...
    public UnfavoriteTrashToggler(Activity activity, String userID, DataReceiver favoriteReceiver)
    {
    ...
    public void setFavoriteIDAndItemID(String favoriteID, String itemID)
    {
