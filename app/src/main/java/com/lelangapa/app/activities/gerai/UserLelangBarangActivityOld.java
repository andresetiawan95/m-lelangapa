package com.lelangapa.app.activities.gerai;
...
import com.lelangapa.app.fragments.gerai.UserLelangBarangFragment;
import com.lelangapa.app.interfaces.DataReceiver;
import com.lelangapa.app.interfaces.InputReceiver;
...
public class UserLelangBarangActivityOld extends AppCompatActivity implements InputReceiver{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        sessionManager = new SessionManager(UserLelangBarangActivityOld.this);
    ...
    public void inputReceived(HashMap<String, String> data) {
        ...
        loading = ProgressDialog.show(UserLelangBarangActivityOld.this,"Sedang diproses..","Harap tunggu...",false,false);
        sendLelangData();
    }
    private void sendLelangData(){
        ...
        queue = Volley.newRequestQueue(UserLelangBarangActivityOld.this);
        ...
        DataReceiver imageReceiver = new DataReceiver() {
            ...
            public void dataReceived(Object output) {
                ...
                if (response.equals("success")){
                    loading.dismiss();
                    Toast.makeText(UserLelangBarangActivityOld.this, "Lelang telah disubmit", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UserLelangBarangActivityOld.this, UserGeraiActivity.class);
