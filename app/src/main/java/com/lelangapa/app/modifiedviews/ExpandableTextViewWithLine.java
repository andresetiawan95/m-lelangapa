package com.lelangapa.app.modifiedviews;
 ...
 */
public class ExpandableTextViewWithLine extends AppCompatTextView
{
    ...
    public ExpandableTextViewWithLine(final Context context)
    {
        this(context, null);
    }

    public ExpandableTextViewWithLine(final Context context, final AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public ExpandableTextViewWithLine(final Context context, final AttributeSet attrs, final int defStyle)
    {
        super(context, attrs, defStyle);

        // read attributes
        final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.ExpandableTextViewWithLine, defStyle, 0);
        this.animationDuration = attributes.getInt(R.styleable.ExpandableTextViewWithLine_animation_duration, 10);
        attributes.recycle();
    ...
    /**
     * Toggle the expanded state of this {@link ExpandableTextViewWithLine}.
    ...
    /**
     * Expand this {@link ExpandableTextViewWithLine}.
    ...
    public boolean expand()
    {
        if (!this.expanded && !this.animating && this.maxLines >= 0)
        {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
            {
                ...
                {
                    final ViewGroup.LayoutParams layoutParams = ExpandableTextViewWithLine.this.getLayoutParams();
                    layoutParams.height = (int) animation.getAnimatedValue();
                    ExpandableTextViewWithLine.this.setLayoutParams(layoutParams);
                }
            });
            ...
            valueAnimator.addListener(new AnimatorListenerAdapter()
            {
                ...
                public void onAnimationEnd(final Animator animation)
                {
                    ...
                    ExpandableTextViewWithLine.this.expanded = true;
                    ExpandableTextViewWithLine.this.animating = false;
                }
            });
        ...
        if (this.expanded && !this.animating && this.maxLines >= 0)
        {
            ...
            valueAnimator.addListener(new AnimatorListenerAdapter()
            {
                ...
                public void onAnimationEnd(final Animator animation)
                {
                    ...
                    ExpandableTextViewWithLine.this.setMaxLines(ExpandableTextViewWithLine.this.maxLines);
                    ...
                    // keep track of current status
                    ExpandableTextViewWithLine.this.expanded = false;
                    ExpandableTextViewWithLine.this.animating = false;
                }
            });
    ...
    /**
     * Sets a listener which receives updates about this {@link ExpandableTextViewWithLine}.
    ...
    /**
     * Is this {@link ExpandableTextViewWithLine} expanded or not?
     ...
     * a {@link ExpandableTextViewWithLine} is expanded or collapsed.
     */
    public interface OnExpandListener
    {
        /**
         * The {@link ExpandableTextViewWithLine} is being expanded.
         * @param view the textview
         */
        void onExpand(ExpandableTextViewWithLine view);

        /**
         * The {@link ExpandableTextViewWithLine} is being collapsed.
         * @param view the textview
         */
        void onCollapse(ExpandableTextViewWithLine view);
    }
}