...
public class SessionManager {
    ...
    private static final String DUMMY_AVATAR = "null";
    ...
    public void createSession(String id, String username, String name, String email, String domain, String avatar, String token){
    ...
    public void editAvatarSessionPreference(String avatar) {
        editor = sessionPreferences.edit();
        editor.putString(KEY_AVATAR,avatar);
        editor.apply();
    }
    public HashMap<String, String> getSession(){
        ...
        sessionMap.put(KEY_AVATAR, sessionPreferences.getString(KEY_AVATAR, DUMMY_AVATAR));
